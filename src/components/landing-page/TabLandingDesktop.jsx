...
const TabLandingHero = () => {
  return (
    <div
      className="h-screen lg:hidden sm:hidden md:block hidden  bg-cover bg-center"
      style={{ backgroundImage: `url(${tabbg.src})` }}
    >
      <div className="pt-80  font-bold flex justify-center">
      ...
      <button className="text-white text-[18px] bg-[#515CDA] border py-3 rounded-lg px-8">Get Started</button>
      </div>
    </div>
  );
};
