...
const MobileLandingHero = () => {
  return (
    <div
      className="h-screen lg:hidden md:hidden flex flex-col gap-7 bg-cover bg-center p-[16px]"
    ...
    >
      ...
      <Link className="mt-5 text-white text-[18px] bg-[#515CDA] border py-3 rounded-lg px-8" href={'https://app.prfec.ai'}>Get Started</Link>
      </div>
    </div>
  );
};
