    ...
    <div className='navbar'>
      <div className='navbar-container'>
        ...
        <div className='navbar-contents'>
          ...
          <Link href="/login" className='navbar-login' onClick={handleLinkClick} style={{marginLeft:"10px"}}>Get Started</Link>
        </div>
        ):
        (
          <div className='navbar-contents'>
        ...
        {menuOpen && (
          ...
          <div className='navbar-contents-category'>Resources</div>
          <div className='navbar-contents-category'>Contact us</div>
              <Link href="/login" className='navbar-login' onClick={handleLinkClick}>Get Started</Link>
              </>
            ) : (
              <>
          <div className='navbar-contents-category'>Services</div>
